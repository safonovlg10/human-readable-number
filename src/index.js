module.exports = function toReadable(number) {
  ...
  if (strNumber.length === 3) {
    if (number % 100 !== 0 && number % 100 < 10) {
      // 101 --- 109
      return (
        `${arrDataUnits[strNumber[0]]} ` +
        `hundred` +
        ` ${arrDataUnits[strNumber[2]]}`
      );
    }
    if (number % 100 !== 0 && number % 10 !== 0 && number % 100 >= 20) {
      ...
      return (
        `${arrDataUnits[strNumber[0]]} ` +
        `hundred` +
        ` ${arrDataTens[strNumber[1] - 2]} ${arrDataUnits[strNumber[2]]}`
      );
    }
    if (number % 100 !== 0 && number % 100 <= 19 && number % 100 > 10) {
      // when 111 --- 119 given  >>
      return (
        `${arrDataUnits[strNumber[0]]} ` +
        `hundred` +
        ` ${arrDataUnits[strNumber[1] + strNumber[2]]}`
      );
    }
    if (number % 100 !== 0 && number % 10 === 0) {
      if (
        number % 100 !== 0 &&
        number % 10 === 0 &&
        Number(strNumber[1]) === 1 &&
        Number(strNumber[2]) === 0
      ) {
        return (
          `${arrDataUnits[strNumber[0]]} ` +
          `hundred` +
